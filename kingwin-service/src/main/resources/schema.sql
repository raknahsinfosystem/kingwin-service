...
create table if not exists material(id int primary key AUTO_INCREMENT, materialId int, materialName varchar(50),syllabus varchar(50),branch varchar(50),file blob, language varchar(50),createdDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updatedDate TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP);
